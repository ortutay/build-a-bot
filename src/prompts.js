...
export const access = ({ agent, url, prompt }) => `You are part of a team of agents building a web scraper using JavaScript. Your specific task is to determine the best way to access a website for a user request. Optimize for cost, speed, and coverage of the data relevant to the user.
...
Write a plain-English report for a coordinating agent, explaining the recommended rendering approach and the evidence supporting it.

${setup({ agent, url, prompt })}`;

export const plan = ({ agent, url, prompt }) => `You are writing a JavaScript web scraping script. Explore and gather information until you can write the script.
